...
import { FaLandmark, FaBuilding } from 'react-icons/fa';
                ...
                {user_info.education.map((edu, index) => (
                    <div key={index}>
                        ...
                        <div className="flex gap-x-3 relative group rounded-lg">
                            <div
                                className="relative last:after:hidden after:absolute after:top-0 after:bottom-0 after:start-3.5 after:w-px after:-translate-x-[0.5px] after:bg-zinc-200 dark:after:bg-zinc-700 dark:group-hover:after:bg-zinc-600">
                                <div className="relative z-10 size-7 flex justify-center items-center">
                                    <div
                                        className="size-2 rounded-full bg-white border-2 border-zinc-300 group-hover:border-zinc-600 dark:bg-zinc-800 dark:border-zinc-600 dark:group-hover:border-zinc-600"></div>
                                </div>
                            </div>
                                ...
                                return (
                                    <div className="hs-carousel-slide relative" key={index}>
                                        {cert.icon === "ibm" ? (
                                            ...
                                            <img
                                                className="w-9 h-9 rounded-full absolute right-5 top-3 text-3xl"
                                        ...
                                        <div
                                            className="flex justify-center items-center h-full bg-gray-100 p-6 dark:bg-neutral-900">
            ...
            <span className="text-2xl" aria-hidden="true">
              ...
              >
                <path d="m9 18 6-6-6-6"></path>
                    ...
                    {/* =========== CAROUSEL PAGINATION =========== */}
                    <div
                        className="hs-carousel-pagination flex justify-center absolute bottom-3 start-0 end-0 space-x-2">
                        {user_info.certificates.map((cert, index) => {
                            return (
                                <span
                                    ...
                                    <ul className="list-disc list-inside text-zinc-800 dark:text-white mt-2">
                                        {exp.descriptions.map((desc, index) => (
                                            <li className="flex space-x-3" key={index}>
                                                <svg
                                                    className="flex-shrink-0 w-4 h-4 mt-0.5 text-red-800 dark:text-red-500"
